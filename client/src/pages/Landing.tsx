      ...
      <section className="max-w-7xl mx-auto px-6 py-20 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1">
          ...
          <div className="mt-8 flex gap-4">
            ...
            <button className="border px-6 py-3 rounded-xl font-semibold hover:bg-gray-100">
              Learn More
            </button>
          </div>
        </div>
...
<footer className="bg-gray-900 text-white mt-20">
  ...
  <div className="max-w-7xl mx-auto px-6 py-12">
    ...
    <div className="flex flex-col md:flex-row justify-between items-center">
      ...
      <div>
        ...
        <p className="text-gray-400 mt-2">
          Bridging citizens to the welfare they deserve.
        </p>
    ...
    <p className="text-center text-gray-400">
      © 2026 Setu AI. All Rights Reserved.
    </p>
